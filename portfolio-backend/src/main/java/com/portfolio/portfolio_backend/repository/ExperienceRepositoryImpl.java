...
public class ExperienceRepositoryImpl implements IExperienceRepository {
    ...
    private final RowMapper<Experience> experienceRowMapper = (rs, numRom) -> {
    ...
    public Experience save(Experience experience) {
        if(experience.getId()==null){
            ...
            String sql = "update experiences set job_title = ?, company_name = ?, start_date = ?," +
                    "end_date = ?, description = ?, personal_info_id = ? where id = ?";
