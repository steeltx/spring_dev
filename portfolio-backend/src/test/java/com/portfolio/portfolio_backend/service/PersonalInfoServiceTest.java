...
public class PersonalInfoServiceTest {
    ...
    void testSaveValidPersonalInfo() {
        PersonalInfo validInfo = new PersonalInfo(null, "John", "Doe", "Developer",
                "Descripción", "url", 5, "email@example.com",
                "123456789", "https://linkedin.com", "https://github.com");
        ...
        assertNotNull(personalInfoRepository.findById(savedInfo.getId()).orElse(null),
                "El objeto guardado debe existir en la base de datos");
    }

    @Test
    void testSaveInvalidFirstName() {
        PersonalInfo invalidInfo = new PersonalInfo(null, "", "Doe", "Developer",
                "Descripción", "url", 5, "email@example.com",
                "123456789", "linkedin.com", "github.com");
