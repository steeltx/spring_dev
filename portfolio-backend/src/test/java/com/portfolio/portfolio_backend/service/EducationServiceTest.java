...
public class EducationServiceTest {
    ...
    void testSaveValidEducation() {
        Education validEducation = new Education(null, "Ingeniería de Software",
                "Universidad de XYZ", LocalDate.of(2015, 3, 1),
                LocalDate.of(2020, 12, 15), "Descripción", 1L);
        ...
        assertNotNull(educationRepository.findById(savedEducation.getId()).orElse(null),
